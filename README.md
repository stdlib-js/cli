...
[test-image]: https://github.com/stdlib-js/cli/actions/workflows/test.yml/badge.svg?branch=v0.4.0
[test-url]: https://github.com/stdlib-js/cli/actions/workflows/test.yml?query=branch:v0.4.0
