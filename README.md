...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/cli@v0.4.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/cli/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/cli/actions/workflows/test.yml?query=branch:v0.4.1
